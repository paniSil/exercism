...
def tag_special_ingredients(dish):
    ...
    alergens = ingredients.intersection(SPECIAL_INGREDIENTS)
    return (dish_name, alergens)
...
def compile_ingredients(dishes):
    ...
    all_dishes = set()
    for dish in dishes:
        all_dishes = dish.union(all_dishes)
    return all_dishes
...
def separate_appetizers(dishes, appetizers):
    ...
    """
    main_dishes = list(set(dishes) - set(appetizers))
    return main_dishes
...
def singleton_ingredients(dishes, intersection):
    ...
    singletons = set()
    for dish in dishes:
        singleton = dish - intersection
        singletons = singleton.union(singletons)
    return singletons
